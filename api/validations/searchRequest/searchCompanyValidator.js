...
module.exports = function searchPeopleValidator(payload) {
  ...
  if (Validator.isEmpty(payload.type, { min: 2, max: 30 })) {
    errors.type = "Type - my_companies or find_new_company - is required";
  }
  if (!Validator.isIn(payload.type, ["my_companies", "find_new_company"])) {
    errors.type =
      "Type - my_companies or find_new_company - Please enter either";
  }
